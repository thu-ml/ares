...
from ares.attack.autoattack.utils import L0_norm, L1_norm, L2_norm
from ares.attack.autoattack.checks import check_zero_gradients
...
def L1_projection(x2, y2, eps1):
    ...
    Returns:
        torch.Tensor: delta s.th. ||y2 + delta||_1 <= eps1 and 0 <= x2 + y2 + delta <= 1
    """
...
class APGDAttack():
    ...
    Args:
            ...
            norm (): Lp-norm of the attack ('Linf', 'L2', 'L0' supported).
            n_restarts (): Number of random restarts.
            eps (): Bound on the norm of perturbations.
            seed (): Random seed for the starting point.
            loss (): Loss to optimize ('ce', 'dlr' supported).
            eot_iter (): Iterations for Expectation over Trasforma
            rho (): Parameter for decreasing the step size.
            topk (): Top k.
            verbose (): Whether to print informaiton.
            device (): torch.device.
            use_largereps (): Whether to use larger eps.
            is_tf_model (): whether tenforflow model or not.
            logger (): Logger.
    """
