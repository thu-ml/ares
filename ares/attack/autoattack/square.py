...
from ares.attack.autoattack.autopgd_base import L1_projection
...
class SquareAttack():
    ...
    Args:
            ...
            norm (): Lp-norm of the attack ('Linf', 'L2' supported).
            n_queries (): Max number of queries (each restart).
            eps (): Bound on the norm of perturbations.
            p_init (): Parameter to control size of squares.
            n_restarts (): Number of random restarts.
            seed (): Random seed.
            verbose (): Whether to print information.
            targeted (): Targeted or not.
            loss (): Loss function optimized ('margin', 'ce' supported).
            resc_schedule (): Adapt schedule of p to n_queries.
            device (): torch.device.
    """
