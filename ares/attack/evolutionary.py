...
class Evolutionary(BatchAttack):
    ...
    def _batch_attack_generator(self, xs, ys, ys_target):
        ...
        xs_shm_file = tempfile.NamedTemporaryFile(prefix='/dev/shm/ares_evolutionary_')
        xs_adv_shm_file = tempfile.NamedTemporaryFile(prefix='/dev/shm/ares_evolutionary_xs_adv_')
