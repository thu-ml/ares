...
from .layers import CrossNorm, SelfNorm, CNSN
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
        ...
        selfnorm = SelfNorm(outplanes)
        self.cnsn = CNSN(crossnorm=None, selfnorm=selfnorm)
...
@register_model
def cnsn_resnet50(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnet50d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnet101(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnet101d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnet152(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnet152d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnext50_32x4d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnext50d_32x4d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnext101_32x4d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnext101_32x8d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnext101_64x4d(pretrained=False, **kwargs):
...
@register_model
def cnsn_resnetblur50(pretrained=False, **kwargs):
