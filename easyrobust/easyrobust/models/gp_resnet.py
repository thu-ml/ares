...
from .layers import GaussianPooling2d
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
        ...
        if stride > 1:
            self.pooling = GaussianPooling2d(num_features=outplanes, kernel_size=stride, stride=stride, stochasticity='CN')
        else:
            self.pooling = None
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
        ...
        if deep_stem:
            ...
            self.conv1 = nn.Conv2d(in_chans, inplanes, kernel_size=7, stride=1, padding=3, bias=False)

        self.pool1 = GaussianPooling2d(num_features=inplanes, kernel_size=2, stride=2, stochasticity='CN')
        ...
        if replace_stem_pool:
            ...
            if aa_layer is not None:
                ...
                self.maxpool = GaussianPooling2d(num_features=inplanes, kernel_size=3, stride=2, padding=1, stochasticity='CN')
...
@register_model
def gp_resnet50(pretrained=False, **kwargs):
...
@register_model
def gp_resnet50d(pretrained=False, **kwargs):
...
@register_model
def gp_resnet101(pretrained=False, **kwargs):
...
@register_model
def gp_resnet101d(pretrained=False, **kwargs):
...
@register_model
def gp_resnet152(pretrained=False, **kwargs):
...
@register_model
def gp_resnet152d(pretrained=False, **kwargs):
...
@register_model
def gp_resnext50_32x4d(pretrained=False, **kwargs):
...
@register_model
def gp_resnext50d_32x4d(pretrained=False, **kwargs):
...
@register_model
def gp_resnext101_32x4d(pretrained=False, **kwargs):
...
@register_model
def gp_resnext101_32x8d(pretrained=False, **kwargs):
...
@register_model
def gp_resnext101_64x4d(pretrained=False, **kwargs):
...
@register_model
def gp_resnetblur50(pretrained=False, **kwargs):
