...
from .layers import DWT_2D_tiny
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
        ...
        if(stride==1):
            ...
            self.conv2 = nn.Sequential(Downsample(wavename = 'haar'),
                nn.Conv2d(
                first_planes, outplanes, kernel_size=3, padding=dilation, dilation=dilation, bias=False))
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
        ...
        if(stride==1):
            ...
            self.conv3 = nn.Sequential(Downsample(wavename = 'haar'),
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
        ...
        if replace_stem_pool:
            ...
            self.maxpool = nn.Sequential(*[Downsample(wavename = 'haar')])
...
@register_model
def wave_resnet50(pretrained=False, **kwargs):
...
@register_model
def wave_resnet50d(pretrained=False, **kwargs):
...
@register_model
def wave_resnet101(pretrained=False, **kwargs):
...
@register_model
def wave_resnet101d(pretrained=False, **kwargs):
...
@register_model
def wave_resnet152(pretrained=False, **kwargs):
...
@register_model
def wave_resnet152d(pretrained=False, **kwargs):
...
@register_model
def wave_resnext50_32x4d(pretrained=False, **kwargs):
...
@register_model
def wave_resnext50d_32x4d(pretrained=False, **kwargs):
...
@register_model
def wave_resnext101_32x4d(pretrained=False, **kwargs):
...
@register_model
def wave_resnext101_32x8d(pretrained=False, **kwargs):
...
@register_model
def wave_resnext101_64x4d(pretrained=False, **kwargs):
