...
if args.resume:
    ...
    assert os.path.isdir(os.path.join(os.path.dirname(__file__),'../../../../attack_benchmark/checkpoint/')), 'Error: no checkpoint directory found!'
    checkpoint = torch.load(os.path.join(os.path.dirname(__file__),'../../../../attack_benchmark/checkpoint/GoogLeNet_ckpt.pth'))
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir(os.path.join(os.path.dirname(__file__),'../../../../attack_benchmark/checkpoint')):
            os.mkdir('checkpoint')
        torch.save(state, os.path.join(os.path.dirname(__file__),'../../../../attack_benchmark/checkpoint/GoogLeNet_ckpt.pth'))
        best_acc = acc
