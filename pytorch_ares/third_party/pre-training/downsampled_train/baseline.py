...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/40_2', help='Folder to save checkpoints.')
...
train_data = ImageNetDS('./imagenet32/', 32, train=True, transform=train_transform)
test_data = ImageNetDS('./imagenet32/', 32, train=False, transform=test_transform)
num_classes = 1000
