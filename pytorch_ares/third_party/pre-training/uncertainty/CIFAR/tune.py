...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/tuned', help='Folder to save checkpoints.')
parser.add_argument('--load', '-l', type=str, default='./snapshots/imagenet', help='Checkpoint path to resume / test.')
