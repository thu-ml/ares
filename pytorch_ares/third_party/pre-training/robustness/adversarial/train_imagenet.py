...
parser = argparse.ArgumentParser(description='Trains a Downsampled ImageNet Classifier',
...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/imagenet_untargetted_10', help='Folder to save checkpoints.')
parser.add_argument('--load', '-l', type=str, default='', help='Checkpoint path to resume / test.')
parser.add_argument('--test', '-t', action='store_true', help='Test only flag.')
# Acceleration
parser.add_argument('--ngpu', type=int, default=2, help='0 = CPU.')
parser.add_argument('--prefetch', type=int, default=3, help='Pre-fetching threads.')
...
train_data = ImageNetDS('/home/hendrycks/datasets/imagenet32/', 32, train=True, transform=train_transform)
test_data = ImageNetDS('/home/hendrycks/datasets/imagenet32/', 32, train=False, transform=test_transform)
num_classes = 1000
