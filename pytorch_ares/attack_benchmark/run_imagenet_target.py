...
def test(args):
    ...
    net=None
    test_loader=None
    # generate net (generator for cda, target models for others)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack_name', default='tim', help= 'Dataset for this model', choices= ['fgsm', 'bim', 'pgd','mim','si_ni_fgsm','vmi_fgsm','sgm', 'dim', 'tim', 'deepfool', 'cw', 'tta'])
    ...
    parser.add_argument('--stepsize', type= float, default=16/255/20, help='linf: 8/2550.0 and l2: (2.5*eps)/steps that is 0.075')
