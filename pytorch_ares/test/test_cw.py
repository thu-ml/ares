...
import torch
from pytorch_ares.attack_torch import CW
...
def test(args):
    ...
    attack = CW(net, device,args.norm, args.target, args.kappa, args.lr, args.init_const, args.max_iter, args.binary_search_steps, args.dataset_name)
