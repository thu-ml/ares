...
model_path = os.path.join(path,'model/ciafar10_checkpoints/model-wideres-pgdHE-wide10.pt')
...
class AT_HE(torch.nn.Module):
    def __init__(self,device):
        torch.nn.Module.__init__(self)
        self.device=device
        self.model = WideResNet(use_FNandWN = True)
