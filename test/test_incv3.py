...
# model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../example/imagenet/inception_v3_bit.py')
# model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../example/imagenet/inception_v3_jpeg.py')
# model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../example/imagenet/inception_v3_rand.py')
# model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../example/imagenet/resnet_v2_alp.py')
# model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../example/imagenet/ens4_adv_inception_v3.py')
